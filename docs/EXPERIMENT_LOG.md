...
| shadow ranker evaluation | pending | behavior-aware checkpoint + online_robust heuristic | n/a | n/a | n/a | n/a | n/a | n/a | research | **Critical finding:** model predicts BOMB 100% raw / 88% masked in live play vs 6.2% on static eval — severe distribution shift detected. Neural prior NOT ready for hybrid reranking. Script: `scripts/participant/shadow_ranker_eval.py`. |
