...
MAX_BFS_TARGET = 10
MAX_BFS_ENEMY  = 8
MAX_ENEMY_ESCAPE_SIM = 5
MAX_FUTURE_SURVIVABILITY = 4
MAX_RADIUS     = 5
...
MEANINGFUL_ESCAPE_PRESSURE = 180
ESCAPE_PRESSURE_SCORE_MULTIPLIER = 0.6

FUTURE_SAFE_CELL_WEIGHT = 8
FUTURE_BRANCH_WEIGHT = 12
FUTURE_DEPTH_WEIGHT = 8
FUTURE_DEAD_END_PENALTY = 10
FUTURE_SCORE_MULTIPLIER = 0.4
OPEN_ZONE_BONUS = 20
CORRIDOR_PENALTY = 20
DEAD_END_PENALTY = 60
